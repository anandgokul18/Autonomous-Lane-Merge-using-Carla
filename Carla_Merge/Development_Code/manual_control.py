...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            spawn_point = carla.Transform(carla.Location(129.4, -69.5, 7), carla.Rotation(0, 89, 0))
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        #Anand: next line...Adding the lane type to display
        waypoint1 = world.world.get_map().get_waypoint(world.player.get_location(),project_to_road=True, lane_type=(carla.LaneType.Driving | carla.LaneType.Shoulder | carla.LaneType.OnRamp))
        self._info_text = [
            ...
            '',
            'Lane type: %20s' % waypoint1.lane_type]
...
class LaneInvasionSensor(object):
    ...
    def _on_invasion(weak_self, event):
        ...
        # Anand change
        #print(f'Anand log: Lane Crossed: list size: {len(event.crossed_lane_markings)}')
...
def game_loop(args):
    ...
    try:
        ...
        client.set_timeout(60.0) #default was 2
        ...
        world = World(client.load_world('Town04'), hud, args.filter, args.rolename)
